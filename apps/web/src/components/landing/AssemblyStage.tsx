...
export default function AssemblyStage({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        // Сборку показываем не всем.
        //
        // На телефоне её нет совсем: собирать экран шириной 1180 точек на
        // экране в 375 бессмысленно — деталей не разглядеть, а прокрутка
        // залипает на два экрана впустую. Там страница сразу собрана и
        // выглядывает углом справа.
        //
        // Кому системные настройки запрещают анимацию — тоже сразу собранный
        // экран.
