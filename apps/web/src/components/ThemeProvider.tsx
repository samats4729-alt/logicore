...
export default function ThemeProvider({ children }: { children: ReactNode }) {
     ...
     * админка, главная, возврат из банка после оплаты и публичные страницы —
     * вход, регистрация, восстановление пароля, оферта, конфиденциальность.
     * У всех у них общая обвязка на токенах `.lc-nova`, и обе темы разобраны
     * до последней плашки.
     *
     ...
     *
     * Возврат из банка (`/billing/payment/...`) сюда попал не для полноты:
     * человек уходит платить из тёмного кабинета и возвращается на белую
     * вспышку в тот самый момент, когда ждёт ответа про свои деньги.
     *
