                    ...
                    <div className={styles.explain}>
                        {settings?.enabled ? (
                            <>
                                ...
                                компания с тремя платит {money(draft.priceMonthly * 3)} ₸. Водителям доступ бесплатный.
                    ...
                    <div className={nova.cardBody}>
                        {setup.ready ? (
                            <div className={styles.setup}>
                                ...
                                {/* Куда мы стучимся за ссылкой на оплату.
                                    Показан потому, что адрес по умолчанию
                                    может не совпасть с тем, что выдали
                                    магазину, — а «не удалось связаться»
                                    выглядит одинаково при любом адресе. */}
                                <div className={styles.setupRow}>
                                    <span>Адрес платёжной системы</span>
                                    <b className={styles.setupUrl}>{setup.apiUrl}</b>
                                </div>
