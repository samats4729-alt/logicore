...
export default function ForwarderPartnersPage() {
    ...
    const columns = [
        {
            ...
            render: (text: string, record: any) => (
                <Space>
                    <Avatar icon={<ShopOutlined />} style={{ backgroundColor: record.type === 'FORWARDER' ? '#722ed1' : '#1890ff' }} />
    ...
    return (
        <div>
            <Title level={2} style={{ marginBottom: 24 }}>Партнеры (Экспедитор)</Title>
