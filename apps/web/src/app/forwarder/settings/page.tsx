                ...
                <Card bordered={false}>
                    {!profileComplete && (
                        <Alert
                            ...
                            description="Для возможности создания заявок необходимо полностью заполнить профиль: Название компании, БИН, Юридический адрес, ФИО директора и Банковские реквизиты."
                            type="warning"
                            showIcon
