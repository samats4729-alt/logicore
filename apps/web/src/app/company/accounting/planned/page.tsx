    ...
    return (
        <div className="lc-page" style={{ maxWidth: 1100, margin: '0 auto' }}>
            ...
            <p style={{ color: 'var(--lc-text-ter)', fontSize: 12.5, margin: '14px 4px 0' }}>
                <CalendarOutlined /> Плановая дата берётся из заявки — из полей «Плановая дата оплаты заказчиком / перевозчику». Долг закрывается автоматически, когда вносится оплата по заявке.
            </p>
        </div>
    );
}
