...
/**
 * Карточка счёта — второй уровень раздела «Счета» после журнала.
 *
...
export default function InvoiceCardPage() {
    ...
    const post = async (closeAfter: boolean) => {
        ...
        try {
            ...
            message.success(`Счёт № ${posted.number} проведён`);
            if (closeAfter) router.push('/company/accounting/invoices');
        } catch (e: any) {
    ...
    const cancel = () => {
        let reason = '';
        Modal.confirm({
            title: `Отменить счёт № ${document?.number}?`,
            content: (
                <div>
        ...
        return (
            <div className="lc-page" style={{ maxWidth: 720, margin: '0 auto' }}>
                <Alert
                    ...
                    action={
                        <Button size="small" onClick={() => router.push('/company/accounting/invoices')}>
                            К журналу
                        </Button>
                    }
                />
        ...
        <div className="lc-page" style={{ maxWidth: 1180, margin: '0 auto' }}>
            <div className="lc2-hero" style={{ alignItems: 'flex-start' }}>
                <div>
                    ...
                    <div className="lc-eyebrow">
                        Счёт на оплату · {outgoing ? 'исходящий' : 'входящий'}
                    </div>
            ...
            <div className="lc-card" style={{ padding: 20, marginBottom: 14 }}>
                ...
                >
                    ...
                    {headerField('Срок оплаты', editable ? (
                        <DatePicker
                            size="small"
                            format="DD.MM.YYYY"
                    ...
                    {headerField('Банковский счёт', editable ? (
                        <Select
                            size="small"
