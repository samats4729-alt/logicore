    ...
    return (
        <div className={styles.wrap}>
            ...
            <p className={styles.lead}>
                {/* На «не найден» повторять заголовок бессмысленно: человеку
                    нужно не то же слово другим кеглем, а что делать дальше. */}
                {ошибка
                    ? 'Возможно, ссылка устарела или платёж заводили в другой компании. Откройте кабинет — там видно, до какого числа оплачена подписка.'
                    : оплачено
                        ...
                        : странно
                            ...
                            : состояние === 'FAILED'
                                // Причину банка называем, но одной причины мало:
                                // человек хотел заплатить и должен видеть, что
                                // деньги целы и попытка не последняя.
                                ? `${платёж?.failureDescription || 'Банк отклонил оплату'}. Деньги на карте остались — попробовать ещё раз можно из кабинета.`
                                : ждём
            ...
            <div className={styles.foot}>
                ...
                {/* Переспрашивать есть смысл, только пока ответ ещё в пути:
                    у отказа и у несуществующего платежа ответ уже окончательный. */}
                {состояние === 'PENDING' && !ошибка && (
                    <button
                        type="button"
