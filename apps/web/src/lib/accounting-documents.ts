...
export interface AccountingDocumentDetails extends AccountingDocumentListItem {
    ...
    /**
     * Действует ли согласование на этот счёт.
     *
     * Компания включает порядок «сначала добро, потом оплата» сама, и
     * включение не распространяется на счета, заведённые раньше. Там, где
     * правило не действует, слово «согласование» на экране не появляется.
     */
