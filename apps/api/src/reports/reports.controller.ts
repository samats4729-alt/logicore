...
// Право раздела — «Отчёты». Когда-то оно здесь уже стояло, но выдать его было
// нечем: в «Сотрудниках» такой галочки не существовало, и бухгалтер — тот, кто
// отчёты и собирает — на выгрузку в Excel всегда получал отказ. Тогда
// требование временно свели к «Бухгалтерии». Теперь галочка есть, и право
// снова своё: отчёты закрываются отдельно от ежедневной работы с деньгами.
